...
protocol PluginType {
	...
	func willSend(_ request: RequestType, endpoint: Endpoint)

	/// Called after a response has been received, but before the MoyaProvider has invoked its completion handler.
//	func didReceive(_ result: Result<Moya.Response, MoyaError>, endpoint: Endpoint)

	/// Called to modify a result before completion.
//	func process(_ result: Result<Moya.Response, MoyaError>, endpoint: Endpoint) -> Result<Moya.Response, MoyaError>
}

extension PluginType {
	func prepare(_ request: URLRequest, endpoint: Endpoint) -> URLRequest { request }
	func willSend(_ request: RequestType, endpoint: Endpoint) { }
